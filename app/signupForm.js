...
showMessage(userCredentials.user.email + " ¡Ha sido creado exitósamente!")
  } catch (error) {
    if (error.code === "auth/email-already-in-use") {
      showMessage("¡Este correo ya está en uso!, intente iniciar sesión o crear otro distinto a este.");
      ...
      showMessage("¡Algo a salido mal!, no logro detectar el error.");
    }
  }
});
